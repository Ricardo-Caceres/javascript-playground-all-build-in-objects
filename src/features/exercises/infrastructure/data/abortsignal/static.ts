...
export const abortSignalStaticExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'aborted is true', assertion: "expect(AbortSignal.abort().aborted).toBe(true)" },
      { description: 'instanceof AbortSignal', assertion: "expect(AbortSignal.abort() instanceof AbortSignal).toBeTruthy()" },
      { description: "abort('reason').reason is 'reason'", assertion: "expect(AbortSignal.abort('reason').reason).toBe('reason')" },
      { description: 'timeout(1000) instanceof AbortSignal', assertion: "expect(AbortSignal.timeout(1000) instanceof AbortSignal).toBeTruthy()" },
      { description: 'timeout(99999).aborted is false', assertion: "expect(AbortSignal.timeout(99999).aborted).toBe(false)" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "reason is 'reason'", assertion: "expect(AbortSignal.abort('reason').reason).toBe('reason')" },
      { description: 'aborted is true', assertion: "expect(AbortSignal.abort().aborted).toBe(true)" },
      { description: 'instanceof AbortSignal', assertion: "expect(AbortSignal.abort() instanceof AbortSignal).toBeTruthy()" },
      { description: 'timeout(1000) instanceof AbortSignal', assertion: "expect(AbortSignal.timeout(1000) instanceof AbortSignal).toBeTruthy()" },
      { description: 'timeout(99999).aborted is false', assertion: "expect(AbortSignal.timeout(99999).aborted).toBe(false)" },
  ...
  },
  {
    ...
    tests: [
      { description: 'instanceof AbortSignal', assertion: "expect(AbortSignal.timeout(1000) instanceof AbortSignal).toBeTruthy()" },
      { description: 'timeout(99999).aborted is false', assertion: "expect(AbortSignal.timeout(99999).aborted).toBe(false)" },
      { description: 'aborted is true for AbortSignal.abort()', assertion: "expect(AbortSignal.abort().aborted).toBe(true)" },
      { description: "abort('reason').reason is 'reason'", assertion: "expect(AbortSignal.abort('reason').reason).toBe('reason')" },
      { description: 'abort() instanceof AbortSignal', assertion: "expect(AbortSignal.abort() instanceof AbortSignal).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'timeout(99999).aborted is false', assertion: "expect(AbortSignal.timeout(99999).aborted).toBe(false)" },
      { description: 'timeout instanceof AbortSignal', assertion: "expect(AbortSignal.timeout(1000) instanceof AbortSignal).toBeTruthy()" },
      { description: 'AbortSignal.abort().aborted is true', assertion: "expect(AbortSignal.abort().aborted).toBe(true)" },
      { description: "abort('reason').reason is 'reason'", assertion: "expect(AbortSignal.abort('reason').reason).toBe('reason')" },
      { description: 'abort() instanceof AbortSignal', assertion: "expect(AbortSignal.abort() instanceof AbortSignal).toBeTruthy()" },
    ],
