...
export const booleanConstructorExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'Boolean(1) is truthy', assertion: 'expect(Boolean(1)).toBeTruthy()' },
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'Boolean(0) is falsy', assertion: 'expect(Boolean(0)).toBeFalsy()' },
      { description: 'Boolean(-0) is false', assertion: 'expect(Boolean(-0)).toBe(false)' },
      { description: 'Boolean(NaN) is false', assertion: 'expect(Boolean(NaN)).toBe(false)' },
      { description: 'Boolean(0) is not true', assertion: 'expect(Boolean(0) === true).toBe(false)' },
    ],
  ...
  },
  {
    ...
    solution: `Boolean('')`,
    tests: [
      { description: "Boolean('') is false", assertion: "expect(Boolean('')).toBe(false)" },
      { description: "Boolean('') is falsy", assertion: "expect(Boolean('')).toBeFalsy()" },
      { description: 'Boolean(undefined) is false', assertion: 'expect(Boolean(undefined)).toBe(false)' },
      { description: 'Boolean(null) is false', assertion: 'expect(Boolean(null)).toBe(false)' },
  ...
  },
  {
    ...
    tests: [
      { description: "Boolean('hello') is true", assertion: "expect(Boolean('hello')).toBe(true)" },
      { description: "Boolean('hello') is truthy", assertion: "expect(Boolean('hello')).toBeTruthy()" },
  ...
  },
  {
    ...
    tests: [
      { description: 'Boolean(null) is false', assertion: 'expect(Boolean(null)).toBe(false)' },
      { description: 'Boolean(null) is falsy', assertion: 'expect(Boolean(null)).toBeFalsy()' },
      { description: 'Boolean(undefined) is false', assertion: 'expect(Boolean(undefined)).toBe(false)' },
      { description: 'Boolean({}) is true', assertion: 'expect(Boolean({})).toBe(true)' },
      { description: 'Boolean([]) is true', assertion: 'expect(Boolean([])).toBe(true)' },
    ],
