...
export const booleanConstructorExercises: Exercise[] = [
  {
    ...
    difficulty: 'beginner',
    builtIn: 'Boolean',
    initialCode: `const result = Boolean(1);`,
    solution: `const result = Boolean(1);`,
    tests: [
...
Boolean(0)   // → false`,
  ...
  },
  {
    ...
    difficulty: 'beginner',
    builtIn: 'Boolean',
    initialCode: `const result = Boolean(0);`,
    solution: `const result = Boolean(0);`,
    tests: [
...
Boolean(NaN) // → false`,
  ...
  },
  {
    ...
    difficulty: 'beginner',
    builtIn: 'Boolean',
    initialCode: `const result = Boolean('');`,
    solution: `const result = Boolean('');`,
    tests: [
      { description: "result is false", assertion: "expect(result).toBe(false)" },
      { description: "result is falsy", assertion: "expect(result).toBeFalsy()" },
...
Boolean('hi')  // → true`,
  ...
  },
  {
    ...
    difficulty: 'beginner',
    builtIn: 'Boolean',
    initialCode: `const result = Boolean('hello');`,
    solution: `const result = Boolean('hello');`,
    tests: [
      { description: "result is true", assertion: "expect(result).toBe(true)" },
      { description: "result is truthy", assertion: "expect(result).toBeTruthy()" },
...
Boolean('0')     // → true`,
  ...
  },
  {
    ...
    difficulty: 'beginner',
    builtIn: 'Boolean',
    initialCode: `const result = Boolean(null);`,
    solution: `const result = Boolean(null);`,
    tests: [
      { description: 'result is false', assertion: 'expect(result).toBe(false)' },
      { description: 'result is falsy', assertion: 'expect(result).toBeFalsy()' },
      { description: 'Boolean(undefined) is false', assertion: 'expect(Boolean(undefined)).toBe(false)' },
