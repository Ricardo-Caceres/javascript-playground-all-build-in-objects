...
export const dateConstructorExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'getFullYear() === 1970', assertion: "expect(new Date(0).getFullYear() === 1970).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "new Date('2024-01-15').getFullYear() returns 2024", assertion: "expect(new Date('2024-01-15').getFullYear()).toBe(2024)" },
      { description: 'result is a number', assertion: "expect(typeof new Date('2024-01-15').getFullYear()).toBe('number')" },
      ...
      { description: 'getFullYear() === 2024', assertion: "expect(new Date('2024-01-15').getFullYear() === 2024).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'new Date(2024, 0, 15).getMonth() returns 0', assertion: "expect(new Date(2024, 0, 15).getMonth()).toBe(0)" },
      ...
      { description: 'month 0 means January', assertion: "expect(new Date(2024, 0, 15).getMonth() === 0).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "typeof new Date(0) is 'object'", assertion: "expect(typeof new Date(0)).toBe('object')" },
      ...
      { description: "typeof result === 'object'", assertion: "expect(typeof new Date(0) === 'object').toBeTruthy()" },
    ],
