...
export const dateGetMillisecondsExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'result is a number', assertion: "expect(typeof new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds()).toBe('number')" },
      { description: 'result === 500', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds() === 500).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds())).toBeTruthy()" },
      { description: 'result >= 0', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds() >= 0).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'getMilliseconds() returns 0', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 0).getMilliseconds()).toBe(0)" },
      { description: 'result is a number', assertion: "expect(typeof new Date(2024, 0, 15, 12, 30, 45, 0).getMilliseconds()).toBe('number')" },
      { description: 'result === 0', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 0).getMilliseconds() === 0).toBeTruthy()" },
      { description: 'result >= 0', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 0).getMilliseconds() >= 0).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date(2024, 0, 15, 12, 30, 45, 0).getMilliseconds())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'getMilliseconds() returns 999', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 999).getMilliseconds()).toBe(999)" },
      { description: 'result is a number', assertion: "expect(typeof new Date(2024, 0, 15, 12, 30, 45, 999).getMilliseconds()).toBe('number')" },
      { description: 'result === 999', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 999).getMilliseconds() === 999).toBeTruthy()" },
      { description: 'result <= 999', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 999).getMilliseconds() <= 999).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date(2024, 0, 15, 12, 30, 45, 999).getMilliseconds())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "typeof result is 'number'", assertion: "expect(typeof new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds()).toBe('number')" },
      { description: 'result >= 0', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds() >= 0).toBeTruthy()" },
      { description: 'result <= 999', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds() <= 999).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds())).toBeTruthy()" },
      { description: 'result is not NaN', assertion: "expect(!isNaN(new Date(2024, 0, 15, 12, 30, 45, 500).getMilliseconds())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'getMilliseconds() returns 750', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 750).getMilliseconds()).toBe(750)" },
      ...
      { description: 'result is a number', assertion: "expect(typeof new Date(2024, 0, 15, 12, 30, 45, 750).getMilliseconds()).toBe('number')" },
      { description: 'result <= 999', assertion: "expect(new Date(2024, 0, 15, 12, 30, 45, 750).getMilliseconds() <= 999).toBeTruthy()" },
    ],
