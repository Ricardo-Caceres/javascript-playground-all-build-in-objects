...
export const dateGetUTCFullYearExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'getUTCFullYear() returns 2024', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBe(2024)" },
      { description: 'result is a number', assertion: "expect(typeof new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBe('number')" },
      { description: 'result === 2024', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear() === 2024).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear())).toBeTruthy()" },
      { description: 'result > 0', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear() > 0).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'new Date(0).getUTCFullYear() returns 1970', assertion: "expect(new Date(0).getUTCFullYear()).toBe(1970)" },
      { description: 'result is a number', assertion: "expect(typeof new Date(0).getUTCFullYear()).toBe('number')" },
      { description: 'result === 1970', assertion: "expect(new Date(0).getUTCFullYear() === 1970).toBeTruthy()" },
      { description: 'result > 1969', assertion: "expect(new Date(0).getUTCFullYear() > 1969).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date(0).getUTCFullYear())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "typeof result is 'number'", assertion: "expect(typeof new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBe('number')" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear())).toBeTruthy()" },
      { description: 'result > 0', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear() > 0).toBeTruthy()" },
      { description: 'result is finite', assertion: "expect(Number.isFinite(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear())).toBeTruthy()" },
      { description: 'result is not NaN', assertion: "expect(!isNaN(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'getUTCFullYear() returns 2000', assertion: "expect(new Date(Date.UTC(2000, 0, 1)).getUTCFullYear()).toBe(2000)" },
      { description: 'result is a number', assertion: "expect(typeof new Date(Date.UTC(2000, 0, 1)).getUTCFullYear()).toBe('number')" },
      { description: 'result === 2000', assertion: "expect(new Date(Date.UTC(2000, 0, 1)).getUTCFullYear() === 2000).toBeTruthy()" },
  ...
  },
  {
    ...
    tests: [
      { description: '2025 > 2024 by UTC year', assertion: "expect(new Date('2025-01-15T00:00:00.000Z').getUTCFullYear() > new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBeTruthy()" },
      { description: 'difference is 1', assertion: "expect(new Date('2025-01-15T00:00:00.000Z').getUTCFullYear() - new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBe(1)" },
      { description: '2024 UTC year is 2024', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBe(2024)" },
      { description: '2025 UTC year is 2025', assertion: "expect(new Date('2025-01-15T00:00:00.000Z').getUTCFullYear()).toBe(2025)" },
      { description: 'both are numbers', assertion: "expect(typeof new Date('2024-01-15T00:00:00.000Z').getUTCFullYear()).toBe('number')" },
    ],
