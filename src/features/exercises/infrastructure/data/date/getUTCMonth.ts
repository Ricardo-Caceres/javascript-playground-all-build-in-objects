...
export const dateGetUTCMonthExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'getUTCMonth() returns 0 for January', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCMonth()).toBe(0)" },
      { description: 'result is a number', assertion: "expect(typeof new Date('2024-01-15T00:00:00.000Z').getUTCMonth()).toBe('number')" },
      { description: 'result === 0', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCMonth() === 0).toBeTruthy()" },
      { description: 'result >= 0', assertion: "expect(new Date('2024-01-15T00:00:00.000Z').getUTCMonth() >= 0).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date('2024-01-15T00:00:00.000Z').getUTCMonth())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'getUTCMonth() returns 5 for June', assertion: "expect(new Date('2024-06-15T12:30:45.000Z').getUTCMonth()).toBe(5)" },
      { description: 'result is a number', assertion: "expect(typeof new Date('2024-06-15T12:30:45.000Z').getUTCMonth()).toBe('number')" },
      { description: 'result === 5', assertion: "expect(new Date('2024-06-15T12:30:45.000Z').getUTCMonth() === 5).toBeTruthy()" },
      { description: 'result >= 0', assertion: "expect(new Date('2024-06-15T12:30:45.000Z').getUTCMonth() >= 0).toBeTruthy()" },
      { description: 'result <= 11', assertion: "expect(new Date('2024-06-15T12:30:45.000Z').getUTCMonth() <= 11).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'getUTCMonth() returns 11 for December', assertion: "expect(new Date('2024-12-25T00:00:00.000Z').getUTCMonth()).toBe(11)" },
      { description: 'result is a number', assertion: "expect(typeof new Date('2024-12-25T00:00:00.000Z').getUTCMonth()).toBe('number')" },
      { description: 'result === 11', assertion: "expect(new Date('2024-12-25T00:00:00.000Z').getUTCMonth() === 11).toBeTruthy()" },
      { description: 'result <= 11', assertion: "expect(new Date('2024-12-25T00:00:00.000Z').getUTCMonth() <= 11).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date('2024-12-25T00:00:00.000Z').getUTCMonth())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "typeof result is 'number'", assertion: "expect(typeof new Date('2024-06-15T12:30:45.000Z').getUTCMonth()).toBe('number')" },
      { description: 'result >= 0', assertion: "expect(new Date('2024-06-15T12:30:45.000Z').getUTCMonth() >= 0).toBeTruthy()" },
      { description: 'result <= 11', assertion: "expect(new Date('2024-06-15T12:30:45.000Z').getUTCMonth() <= 11).toBeTruthy()" },
      { description: 'result is integer', assertion: "expect(Number.isInteger(new Date('2024-06-15T12:30:45.000Z').getUTCMonth())).toBeTruthy()" },
      { description: 'result is not NaN', assertion: "expect(!isNaN(new Date('2024-06-15T12:30:45.000Z').getUTCMonth())).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'new Date(0).getUTCMonth() returns 0', assertion: "expect(new Date(0).getUTCMonth()).toBe(0)" },
      { description: 'result is a number', assertion: "expect(typeof new Date(0).getUTCMonth()).toBe('number')" },
      { description: 'result === 0', assertion: "expect(new Date(0).getUTCMonth() === 0).toBeTruthy()" },
