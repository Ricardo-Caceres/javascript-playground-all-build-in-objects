...
export const dateParsExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "Date.parse('1970-01-01T00:00:00.000Z') returns 0", assertion: "expect(Date.parse('1970-01-01T00:00:00.000Z')).toBe(0)" },
      { description: 'result is a number', assertion: "expect(typeof Date.parse('1970-01-01T00:00:00.000Z')).toBe('number')" },
      { description: 'result is not NaN', assertion: "expect(!isNaN(Date.parse('1970-01-01T00:00:00.000Z'))).toBeTruthy()" },
      { description: 'result === 0', assertion: "expect(Date.parse('1970-01-01T00:00:00.000Z') === 0).toBeTruthy()" },
      { description: 'result is finite', assertion: "expect(Number.isFinite(Date.parse('1970-01-01T00:00:00.000Z'))).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "Date.parse('2024-01-15') > 0", assertion: "expect(Date.parse('2024-01-15') > 0).toBeTruthy()" },
      { description: 'result is a number', assertion: "expect(typeof Date.parse('2024-01-15')).toBe('number')" },
  ...
  },
  {
    ...
    tests: [
      { description: "typeof result is 'number'", assertion: "expect(typeof Date.parse('2024-01-15')).toBe('number')" },
      { description: 'result > 0', assertion: "expect(Date.parse('2024-01-15') > 0).toBeTruthy()" },
      { description: 'result is not NaN for valid string', assertion: "expect(!isNaN(Date.parse('2024-01-15'))).toBeTruthy()" },
      { description: 'typeof epoch parse is also number', assertion: "expect(typeof Date.parse('1970-01-01T00:00:00.000Z')).toBe('number')" },
      { description: 'result is finite', assertion: "expect(Number.isFinite(Date.parse('2024-01-15'))).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "Number.isNaN(Date.parse('invalid')) is true", assertion: "expect(Number.isNaN(Date.parse('invalid'))).toBeTruthy()" },
  ...
  },
  {
    ...
    tests: [
      { description: "Date.parse('1970-01-01') >= 0", assertion: "expect(Date.parse('1970-01-01') >= 0).toBeTruthy()" },
      ...
      { description: "UTC epoch is exactly 0", assertion: "expect(Date.parse('1970-01-01T00:00:00.000Z')).toBe(0)" },
    ],
