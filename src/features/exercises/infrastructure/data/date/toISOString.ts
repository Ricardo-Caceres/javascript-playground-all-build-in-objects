...
export const dateToISOStringExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "new Date(0).toISOString() === '1970-01-01T00:00:00.000Z'", assertion: "expect(new Date(0).toISOString()).toBe('1970-01-01T00:00:00.000Z')" },
      { description: 'result is a string', assertion: "expect(typeof new Date(0).toISOString()).toBe('string')" },
      { description: "result ends with 'Z'", assertion: "expect(new Date(0).toISOString().endsWith('Z')).toBeTruthy()" },
      { description: "result contains 'T'", assertion: "expect(new Date(0).toISOString().includes('T')).toBeTruthy()" },
      { description: "result contains '1970'", assertion: "expect(new Date(0).toISOString().includes('1970')).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "result includes 'T'", assertion: "expect(new Date(0).toISOString().includes('T')).toBeTruthy()" },
      { description: 'result is a string', assertion: "expect(typeof new Date(0).toISOString()).toBe('string')" },
      { description: "result ends with 'Z'", assertion: "expect(new Date(0).toISOString().endsWith('Z')).toBeTruthy()" },
      { description: "result includes '1970'", assertion: "expect(new Date(0).toISOString().includes('1970')).toBeTruthy()" },
      { description: 'result length is 24', assertion: "expect(new Date(0).toISOString().length).toBe(24)" },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: "result includes 'T'", assertion: "expect(new Date(0).toISOString().includes('T')).toBeTruthy()" },
      { description: 'result is a string', assertion: "expect(typeof new Date(0).toISOString()).toBe('string')" },
      { description: 'result is truthy', assertion: "expect(new Date(0).toISOString()).toBeTruthy()" },
      { description: 'result length is 24', assertion: "expect(new Date(0).toISOString().length).toBe(24)" },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is a string', assertion: "expect(typeof new Date(0).toISOString()).toBe('string')" },
      { description: "result ends with 'Z'", assertion: "expect(new Date(0).toISOString().endsWith('Z')).toBeTruthy()" },
      { description: "result includes '.000Z' (milliseconds)", assertion: "expect(new Date(0).toISOString().includes('.000Z')).toBeTruthy()" },
      { description: 'result is truthy', assertion: "expect(new Date(0).toISOString()).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "result includes '2024'", assertion: "expect(new Date('2024-01-15T00:00:00.000Z').toISOString().includes('2024')).toBeTruthy()" },
