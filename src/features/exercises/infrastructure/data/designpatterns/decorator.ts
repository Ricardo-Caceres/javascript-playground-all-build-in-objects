...
f(5)`,
    tests: [
      ...
      { description: 'decorator order matters', assertion: "function double(fn){return function(...args){return fn(...args)*2}} function addTen(fn){return function(...args){return fn(...args)+10}} const o=(x)=>x*2; const f1=double(addTen(o)); const f2=addTen(double(o)); expect(f1(5)).not.toBe(f2(5))" },
