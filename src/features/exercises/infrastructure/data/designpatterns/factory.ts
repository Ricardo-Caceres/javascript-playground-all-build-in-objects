...
const user = createUser('Alice', 'admin')`,
    tests: [
      ...
      { description: 'multiple calls create different objects', assertion:"function createUser(n,r){return{type:'user',name:n,role:r}} const u1=createUser('A','x'),u2=createUser('B','y'); expect(u1 !== u2).toBe(true)" },
    ],
