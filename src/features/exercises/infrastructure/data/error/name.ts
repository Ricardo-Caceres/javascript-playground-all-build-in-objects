...
export const errorNameExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "name is 'Error'", assertion: "expect(new Error().name).toBe('Error')" },
      { description: 'name is a string', assertion: "expect(typeof new Error().name).toBe('string')" },
      { description: 'name is truthy', assertion: "expect(new Error().name).toBeTruthy()" },
      { description: 'same for Error with message', assertion: "expect(new Error('msg').name).toBe('Error')" },
      { description: 'name is not null', assertion: "expect(new Error().name).not.toBeNull()" },
    ],
