...
export const eventPropertiesExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "type is 'submit'", assertion: "expect(new Event('submit').type).toBe('submit')" },
      { description: 'isTrusted is false', assertion: "expect(new Event('x').isTrusted).toBe(false)" },
      ...
      { description: 'composed defaults to false', assertion: "expect(new Event('x').composed).toBe(false)" },
    ],
