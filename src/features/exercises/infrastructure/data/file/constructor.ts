...
f.size  // → 2`,
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'has size property from Blob', assertion: "expect('size' in new File(['x'], 'f.txt')).toBe(true)" },
      { description: 'has type property from Blob', assertion: "expect('type' in new File(['x'], 'f.txt')).toBe(true)" },
...
f instanceof Blob  // → true`,
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'has name property', assertion: "expect('name' in new File(['x'], 'f.txt')).toBe(true)" },
    ],
