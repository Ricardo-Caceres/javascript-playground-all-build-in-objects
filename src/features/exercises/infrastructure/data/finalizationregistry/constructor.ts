...
reg instanceof FinalizationRegistry  // → true`,
  ...
  },
  {
    ...
    tests: [
      { description: "result", assertion:"expect(typeof FinalizationRegistry).toBe('function')" },
      { description: 'FinalizationRegistry is a function', assertion:"expect(result).toBe(true)" },
      ...
      { description: 'can be instantiated', assertion:'expect((() => { try { (() => new FinalizationRegistry(() => {}))(); return true; } catch(e) { return false; } })()).toBe(true)' },
    ],
...
typeof reg  // → 'object'`,
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'instanceof FinalizationRegistry', assertion:'expect(result).toBe(true)' },
      { description: 'not null', assertion:'const reg = new FinalizationRegistry(() => {}); expect(reg.register !== null).toBe(true)' },
    ],
