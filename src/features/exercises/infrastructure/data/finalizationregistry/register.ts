...
export const finalizationRegistryRegisterExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'not null', assertion: 'expect(FinalizationRegistry.prototype.register).not.toBeNull()' },
  ...
  },
  {
    ...
    tests: [
      { description: 'register does not throw', assertion: "expect(() => { const reg = new FinalizationRegistry(() => {}); reg.register({}, 'token'); }).not.toThrow()" },
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'not null', assertion: 'expect(FinalizationRegistry.prototype.unregister).not.toBeNull()' },
      { description: "typeof prototype.register === 'function'", assertion: "expect(typeof FinalizationRegistry.prototype.register).toBe('function')" },
    ],
