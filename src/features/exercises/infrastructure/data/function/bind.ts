...
**Challenge:** Verify that \`typeof greet.bind({})\` returns \`'function'\`.`,
  ...
  return typeof greet.bind({})
    ...
    tests: [
      ...
      { description: 'bind result is not null', assertion:"function greet() { return 'hello'; } expect(greet.bind({}) !== null).toBe(true)" },
      { description: 'bind result is not undefined', assertion:"function greet() { return 'hello'; } expect(greet.bind({}) !== undefined).toBe(true)" },
