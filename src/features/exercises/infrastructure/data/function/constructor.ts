...
**Challenge:** Verify that \`typeof new Function()\` returns \`'function'\`.`,
  ...
  return typeof new Function()
    ...
    tests: [
      ...
      { description: 'not undefined', assertion:"expect(typeof new Function() !== 'undefined').toBe(true)" },
    ],
    hints: [
...
**Challenge:** Verify that \`new Function() instanceof Function\` returns \`true\`.`,
  ...
  return new Function() instanceof Function
    ...
    tests: [
      ...
      { description: 'not null', assertion:'expect(new Function() !== null).toBe(true)' },
    ],
    hints: [
...
**Challenge:** Verify that \`typeof Function\` returns \`'function'\`.`,
  ...
  return typeof Function
    ...
    tests: [
      ...
      { description: 'Function is not null', assertion:'expect(Function !== null).toBe(true)' },
...
**Challenge:** Verify that \`new Function('return 42')()\` returns \`42\`.`,
  ...
  return (new Function('return 42'))()
    ...
    tests: [
      ...
      { description: 'is not undefined', assertion:"expect(new Function('return 42')() !== undefined).toBe(true)" },
