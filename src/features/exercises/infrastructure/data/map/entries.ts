...
export const mapEntriesExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "entries are [['a',1],['b',2]]", assertion: "expect([...new Map([['a',1],['b',2]]).entries()]).toEqual([['a',1],['b',2]])" },
      ...
      { description: 'first entry is correct', assertion: "expect([...new Map([['a',1],['b',2]]).entries()][0]).toEqual(['a',1])" },
  ...
  },
  {
    ...
    tests: [
      { description: "entries in insertion order", assertion: "expect([...new Map([['b',2],['a',1]]).entries()]).toEqual([['b',2],['a',1]])" },
  ...
  },
  {
    ...
    tests: [
      { description: 'empty map entries is empty array', assertion: "expect([...new Map().entries()]).toEqual([])" },
      { description: 'length is 0', assertion: "expect([...new Map().entries()].length).toBe(0)" },
      { description: 'iterator is immediately done', assertion: "expect(new Map().entries().next().done).toBe(true)" },
      { description: 'result is an array', assertion: "expect(Array.isArray([...new Map().entries()])).toBe(true)" },
