...
export const mapForEachExercises: Exercise[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'forEach does not throw on empty Map', assertion: "expect(() => new Map().forEach(() => {})).not.toThrow()" },
      ...
      { description: 'forEach is callable on empty Map', assertion: "const m = new Map(); expect(() => m.forEach(() => {})).not.toThrow()" },
    ],
