...
export const mapKeysExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "keys are ['a','b']", assertion: "expect([...new Map([['a',1],['b',2]]).keys()]).toEqual(['a','b'])" },
      ...
      { description: "first key is 'a'", assertion: "expect([...new Map([['a',1],['b',2]]).keys()][0]).toBe('a')" },
      { description: 'keys is an iterable', assertion: "expect(typeof new Map([['a',1]]).keys()[Symbol.iterator]).toBe('function')" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "keys in insertion order ['c','a','b']", assertion: "expect([...new Map([['c',3],['a',1],['b',2]]).keys()]).toEqual(['c','a','b'])" },
  ...
  },
  {
    ...
    tests: [
      { description: "keys() returns an object (iterator)", assertion: "expect(typeof new Map([['a',1]]).keys()).toBe('object')" },
      { description: 'keys() is iterable', assertion: "expect(typeof new Map([['a',1]]).keys()[Symbol.iterator]).toBe('function')" },
      { description: 'keys() has next() method', assertion: "expect(typeof new Map([['a',1]]).keys().next).toBe('function')" },
  ...
  },
  {
    ...
    tests: [
      { description: 'empty map keys is empty array', assertion: "expect([...new Map().keys()]).toEqual([])" },
      { description: 'empty map keys has length 0', assertion: "expect([...new Map().keys()].length).toBe(0)" },
      { description: 'iterator is immediately done', assertion: "expect(new Map().keys().next().done).toBe(true)" },
      { description: 'result is an array', assertion: "expect(Array.isArray([...new Map().keys()])).toBe(true)" },
