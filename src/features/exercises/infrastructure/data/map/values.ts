...
export const mapValuesExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'values are [1,2]', assertion: "expect([...new Map([['a',1],['b',2]]).values()]).toEqual([1,2])" },
      ...
      { description: 'first value is correct', assertion: "expect([...new Map([['a',1],['b',2]]).values()][0]).toBe(1)" },
      { description: 'values is iterable', assertion: "expect(typeof new Map([['a',1]]).values()[Symbol.iterator]).toBe('function')" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'values in insertion order [30,10,20]', assertion: "expect([...new Map([['c',30],['a',10],['b',20]]).values()]).toEqual([30,10,20])" },
  ...
  },
  {
    ...
    tests: [
      { description: "values() returns an object (iterator)", assertion: "expect(typeof new Map([['a',1]]).values()).toBe('object')" },
      { description: 'values() is iterable', assertion: "expect(typeof new Map([['a',1]]).values()[Symbol.iterator]).toBe('function')" },
      { description: 'values() has next() method', assertion: "expect(typeof new Map([['a',1]]).values().next).toBe('function')" },
  ...
  },
  {
    ...
    tests: [
      { description: 'empty map values is empty array', assertion: "expect([...new Map().values()]).toEqual([])" },
      { description: 'length is 0', assertion: "expect([...new Map().values()].length).toBe(0)" },
      { description: 'iterator is immediately done', assertion: "expect(new Map().values().next().done).toBe(true)" },
      { description: 'result is an array', assertion: "expect(Array.isArray([...new Map().values()])).toBe(true)" },
