...
export const mathTanExercises: Exercise[] = [
  {
    ...
    solution: `Math.tan(0)`,
    tests: [
      { description: 'Math.tan(0) returns 0', assertion: "expect(Math.tan(0)).toBe(0)" },
      { description: 'result is a number', assertion: "expect(typeof Math.tan(0)).toBe('number')" },
      { description: 'Math.tan(0) === 0', assertion: "expect(Math.tan(0) === 0).toBeTruthy()" },
      { description: 'result is finite', assertion: "expect(Number.isFinite(Math.tan(0))).toBeTruthy()" },
      { description: 'absolute value is less than 0.001', assertion: "expect(Math.abs(Math.tan(0)) < 0.001).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'typeof Math.tan(0) is number', assertion: "expect(typeof Math.tan(0)).toBe('number')" },
      { description: 'typeof Math.tan(1) is number', assertion: "expect(typeof Math.tan(1)).toBe('number')" },
      { description: 'typeof Math.tan(Math.PI) is number', assertion: "expect(typeof Math.tan(Math.PI)).toBe('number')" },
      { description: 'typeof Math.tan(-1) is number', assertion: "expect(typeof Math.tan(-1)).toBe('number')" },
  ...
  },
  {
    ...
    tests: [
      { description: 'Math.tan(Math.PI) ≈ 0', assertion: "expect(Math.abs(Math.tan(Math.PI)) < 1e-10).toBeTruthy()" },
      { description: 'result is a number', assertion: "expect(typeof Math.tan(Math.PI)).toBe('number')" },
      { description: 'result is finite', assertion: "expect(Number.isFinite(Math.tan(Math.PI))).toBeTruthy()" },
      { description: 'result > -0.001', assertion: "expect(Math.tan(Math.PI) > -0.001).toBeTruthy()" },
      { description: 'result < 0.001', assertion: "expect(Math.tan(Math.PI) < 0.001).toBeTruthy()" },
    ],
