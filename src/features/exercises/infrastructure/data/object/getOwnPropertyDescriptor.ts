...
\`\`\``,
  ...
  return Object.getOwnPropertyDescriptor(obj, 'protoKey') === undefined
    ...
    tests: [
      ...
      { description: 'own key does have a descriptor', assertion: "const o: any = { x: 1 }; expect(Object.getOwnPropertyDescriptor(o, 'x')).not.toBeUndefined()" },
      { description: 'toString is inherited, not own', assertion: "expect(Object.getOwnPropertyDescriptor({}, 'toString')).toBeUndefined()" },
      { description: 'own property overrides inherited descriptor', assertion: "const p = { x: 1 }; const o = Object.create(p) as any; o.x = 2; expect(Object.getOwnPropertyDescriptor(o, 'x')?.value).toBe(2)" },
    ],
    hints: [
