...
export const promiseConstructorExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'instanceof Promise is true', assertion: 'expect(new Promise((res) => res(1)) instanceof Promise).toBe(true)' },
      ...
      { description: 'is not null', assertion: 'expect(new Promise((res) => res(1))).not.toBeNull()' },
  ...
  },
  {
    ...
    tests: [
      { description: "typeof is 'object'", assertion: "expect(typeof new Promise(() => {})).toBe('object')" },
      { description: "not 'function'", assertion: "expect(typeof new Promise(() => {}) === 'function').toBe(false)" },
      { description: "not 'string'", assertion: "expect(typeof new Promise(() => {}) === 'string').toBe(false)" },
      { description: 'instanceof Promise', assertion: 'expect(new Promise(() => {}) instanceof Promise).toBe(true)' },
      { description: 'is not null', assertion: 'expect(new Promise(() => {})).not.toBeNull()' },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'pending promise instanceof Promise', assertion: 'expect(new Promise(() => {}) instanceof Promise).toBe(true)' },
      { description: 'typeof is object', assertion: "expect(typeof new Promise(() => {})).toBe('object')" },
      { description: 'is truthy', assertion: 'expect(new Promise(() => {})).toBeTruthy()' },
      { description: 'is not null', assertion: 'expect(new Promise(() => {})).not.toBeNull()' },
      { description: 'is not undefined', assertion: 'expect(new Promise(() => {})).not.toBeUndefined()' },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'Promise.resolve() instanceof Promise', assertion: 'expect(Promise.resolve(42) instanceof Promise).toBe(true)' },
  ...
  },
  {
    ...
    tests: [
      { description: "typeof Promise is 'function'", assertion: "expect(typeof Promise).toBe('function')" },
      { description: "not 'object'", assertion: "expect(typeof Promise === 'object').toBe(false)" },
      ...
      { description: 'Promise is not null', assertion: 'expect(Promise).not.toBeNull()' },
    ],
