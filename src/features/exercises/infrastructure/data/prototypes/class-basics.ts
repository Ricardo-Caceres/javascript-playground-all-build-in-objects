...
const sound = dog.speak()`,
    tests: [
      ...
      { description: 'multiple instances are independent', assertion:"class Animal{constructor(n){this.name=n}} const a=new Animal('Dog'),b=new Animal('Cat'); expect(a.name !== b.name).toBe(true)" },
      ...
      { description: 'constructor creates new instance each time', assertion:"class Animal{constructor(n){this.n=n}} const a=new Animal(1),b=new Animal(2); expect(a.n !== b.n).toBe(true)" },
    ],
...
const name = person.name`,
    tests: [
      ...
      { description: 'properties independent per instance', assertion:"class Box{constructor(s){this.size=s}} const b1=new Box(10),b2=new Box(20); expect(b1.size !== b2.size).toBe(true)" },
