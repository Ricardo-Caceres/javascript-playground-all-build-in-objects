...
const proto_a = Object.getPrototypeOf(a)`,
    tests: [
      ...
      { description: 'each level can have different prototype', assertion: "const x={}; const y={}; const a=Object.create(x); const b=Object.create(y); expect(Object.getPrototypeOf(a)).not.toBe(Object.getPrototypeOf(b))" },
