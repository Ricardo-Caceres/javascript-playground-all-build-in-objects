...
**Challenge:** Verify that \`new Proxy({}, {}) instanceof Object\` is \`true\`.`,
  ...
  return new Proxy({}, {}) instanceof Object
    ...
    tests: [
      ...
      { description: 'not null', assertion: 'expect(new Proxy({}, {})).not.toBeNull()' },
...
**Challenge:** Verify that \`typeof new Proxy({}, {})\` returns \`'object'\`.`,
  ...
  return typeof new Proxy({}, {})
    ...
    tests: [
      ...
      { description: 'not function', assertion: "expect(typeof new Proxy({}, {})).not.toBe('function')" },
      { description: 'not undefined', assertion: "expect(typeof new Proxy({}, {})).not.toBe('undefined')" },
...
**Challenge:** Verify that \`() => new Proxy(null, {})\` throws.`,
  ...
  try {
    ...
    tests: [
      { description: 'null target throws', assertion: 'expect(() => new Proxy(null as any, {})).toThrow()' },
      { description: 'throws a TypeError', assertion: 'expect(() => new Proxy(null as any, {})).toThrow(TypeError)' },
      { description: 'valid target does not throw', assertion: 'expect(() => new Proxy({}, {})).not.toThrow()' },
