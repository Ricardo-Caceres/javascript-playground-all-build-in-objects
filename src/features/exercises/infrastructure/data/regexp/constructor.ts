...
export const regexpConstructorExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "/hello/.test('hello world') returns true", assertion: "expect(/hello/.test('hello world')).toBe(true)" },
      { description: 'result is boolean', assertion: "expect(typeof /hello/.test('hello world')).toBe('boolean')" },
  ...
  },
  {
    ...
    tests: [
      { description: "new RegExp('hello').test('hello') returns true", assertion: "expect(new RegExp('hello').test('hello')).toBe(true)" },
      ...
      { description: 'result of test() is boolean', assertion: "expect(typeof new RegExp('hello').test('hello')).toBe('boolean')" },
  ...
  },
  {
    ...
    solution: `typeof /abc/`,
    tests: [
      { description: "typeof /abc/ is 'object'", assertion: "expect(typeof /abc/).toBe('object')" },
