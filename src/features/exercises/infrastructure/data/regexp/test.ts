...
export const regexpTestExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "/\\d+/.test('abc123') returns true", assertion: "expect(/\\d+/.test('abc123')).toBe(true)" },
      { description: 'result is boolean', assertion: "expect(typeof /\\d+/.test('abc123')).toBe('boolean')" },
  ...
  },
  {
    ...
    tests: [
      { description: "/^\\d+$/.test('abc') returns false", assertion: "expect(/^\\d+$/.test('abc')).toBe(false)" },
      { description: 'result is boolean', assertion: "expect(typeof /^\\d+$/.test('abc')).toBe('boolean')" },
      { description: "/^\\d+$/.test('123') returns true", assertion: "expect(/^\\d+$/.test('123')).toBe(true)" },
      { description: "/^\\d+$/.test('12a') returns false", assertion: "expect(/^\\d+$/.test('12a')).toBe(false)" },
      { description: 'result is falsy', assertion: "expect(/^\\d+$/.test('abc')).toBeFalsy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is boolean', assertion: "expect(typeof /hello/i.test('HELLO')).toBe('boolean')" },
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is boolean', assertion: "expect(typeof /^$/.test('')).toBe('boolean')" },
      { description: "/.*/.test('') returns true", assertion: "expect(/.*/.test('')).toBe(true)" },
      { description: "result is truthy", assertion: "expect(/^$/.test('')).toBeTruthy()" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "typeof /abc/.test('abc') is 'boolean'", assertion: "expect(typeof /abc/.test('abc')).toBe('boolean')" },
