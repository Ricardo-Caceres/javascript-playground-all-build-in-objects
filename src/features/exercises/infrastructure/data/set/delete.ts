...
export const setDeleteExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'delete existing returns true', assertion: 'expect(new Set([1,2,3]).delete(2)).toBe(true)' },
      { description: 'result is boolean', assertion: "expect(typeof new Set([1,2,3]).delete(2)).toBe('boolean')" },
      { description: 'result is truthy', assertion: 'expect(new Set([1,2,3]).delete(2)).toBeTruthy()' },
      { description: 'delete returns true strictly', assertion: 'expect(new Set([1,2,3]).delete(2) === true).toBe(true)' },
  ...
  },
  {
    ...
    tests: [
      { description: 'delete missing returns false', assertion: 'expect(new Set([1,2,3]).delete(99)).toBe(false)' },
      { description: 'result is boolean', assertion: "expect(typeof new Set([1,2,3]).delete(99)).toBe('boolean')" },
      { description: 'result is falsy', assertion: 'expect(new Set([1,2,3]).delete(99)).toBeFalsy()' },
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'second delete does not throw', assertion: 'const s = new Set([1]); s.delete(1); expect(() => s.delete(1)).not.toThrow()' },
