...
export const setForEachExercises: Exercise[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'forEach does not throw on empty Set', assertion: 'expect(() => new Set().forEach(() => {})).not.toThrow()' },
      ...
      { description: 'forEach callable on empty Set', assertion: 'const s = new Set(); expect(() => s.forEach(() => {})).not.toThrow()' },
    ],
