...
export const setIntersectionExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'result is a Set', assertion: 'expect((new Set([1,2,3]) as any).intersection(new Set([2,3,4])) instanceof Set).toBe(true)' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'empty intersect anything is empty', assertion: 'expect((new Set() as any).intersection(new Set([1,2,3])).size).toBe(0)' },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'original a unchanged', assertion: 'const a = new Set([1,2,3]); (a as any).intersection(new Set([2,3])); expect(a.size).toBe(3)' },
      { description: 'original b unchanged', assertion: 'const a = new Set([1,2,3]); const b = new Set([2,3,4]); (a as any).intersection(b); expect(b.size).toBe(3)' },
      { description: 'result is a new Set', assertion: 'const a = new Set([1,2,3]); const result = (a as any).intersection(new Set([2])); expect(result).not.toBe(a)' },
      { description: 'a still has original elements', assertion: 'const a = new Set([1,2,3]); (a as any).intersection(new Set([2,3])); expect(a.has(1)).toBe(true)' },
      { description: 'result only has common elements', assertion: 'const r = (new Set([1,2,3]) as any).intersection(new Set([2,3,4])); expect(r.has(1)).toBe(false)' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is Set instance', assertion: 'expect((new Set([1,2,3]) as any).intersection(new Set([3,4,5])) instanceof Set).toBe(true)' },
    ],
