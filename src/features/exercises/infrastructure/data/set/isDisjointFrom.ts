...
export const setIsDisjointFromExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'disjoint single elements', assertion: 'expect((new Set([1]) as any).isDisjointFrom(new Set([2]))).toBe(true)' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is truthy', assertion: 'expect((new Set() as any).isDisjointFrom(new Set([1]))).toBeTruthy()' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is boolean', assertion: "expect(typeof (new Set([1,2,3]) as any).isDisjointFrom(new Set([3,4]))).toBe('boolean')" },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'single identical element: not disjoint', assertion: 'expect((new Set([5]) as any).isDisjointFrom(new Set([5]))).toBe(false)' },
    ],
