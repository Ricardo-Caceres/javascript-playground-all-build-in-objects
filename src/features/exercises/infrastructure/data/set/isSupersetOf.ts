...
export const setIsSupersetOfExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'superset of single element', assertion: 'expect((new Set([1,2,3]) as any).isSupersetOf(new Set([1]))).toBe(true)' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is truthy', assertion: 'expect((new Set([1]) as any).isSupersetOf(new Set())).toBeTruthy()' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is truthy', assertion: 'expect((new Set([1,2]) as any).isSupersetOf(new Set([1,2]))).toBeTruthy()' },
    ],
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'result is boolean', assertion: "expect(typeof (new Set([1,2]) as any).isSupersetOf(new Set([1]))).toBe('boolean')" },
    ],
