...
export const setValuesExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: 'values are [1,2,3]', assertion: 'expect([...new Set([1,2,3]).values()]).toEqual([1,2,3])' },
      { description: 'result is an array', assertion: 'expect(Array.isArray([...new Set([1,2,3]).values()])).toBe(true)' },
      ...
      { description: 'values is iterable', assertion: "expect(typeof new Set([1]).values()[Symbol.iterator]).toBe('function')" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'values in insertion order [3,1,2]', assertion: 'expect([...new Set([3,1,2]).values()]).toEqual([3,1,2])' },
  ...
  },
  {
    ...
    tests: [
      { description: 'duplicates not in values output', assertion: 'expect([...new Set([1,1,2,2,3]).values()]).toEqual([1,2,3])' },
      { description: 'length is 3 not 5', assertion: 'expect([...new Set([1,1,2,2,3]).values()].length).toBe(3)' },
  ...
  },
  {
    ...
    tests: [
      { description: 'empty set values is empty array', assertion: 'expect([...new Set().values()]).toEqual([])' },
      { description: 'length is 0', assertion: 'expect([...new Set().values()].length).toBe(0)' },
      { description: 'iterator is immediately done', assertion: 'expect(new Set().values().next().done).toBe(true)' },
      { description: 'result is an array', assertion: 'expect(Array.isArray([...new Set().values()])).toBe(true)' },
  ...
  },
  {
    ...
    tests: [
      { description: "values() returns an object", assertion: "expect(typeof new Set([1]).values()).toBe('object')" },
      { description: 'values() is iterable', assertion: "expect(typeof new Set([1]).values()[Symbol.iterator]).toBe('function')" },
      { description: 'values() has next() method', assertion: "expect(typeof new Set([1]).values().next).toBe('function')" },
