  ...
  return structuredClone(obj);
    ...
    tests: [
      ...
      },
      {
        ...
        assertion: `const orig = { nested: { val: 1 } }; const clone = cloneNested(orig); (clone as any).nested.val = 99; expect(orig.nested.val).toBe(1);`,
      },
      {
  ...
  return structuredClone(arr);
    ...
    tests: [
      ...
      },
      {
        ...
        assertion: `expect((cloneArray([1, [2, 3]]) as any)[0]).toBe(1);`,
      },
      {
        description: 'Nested element is correct',
        assertion: `expect((cloneArray([1, [2, 3]]) as any)[1][0]).toBe(2);`,
      },
    ],
