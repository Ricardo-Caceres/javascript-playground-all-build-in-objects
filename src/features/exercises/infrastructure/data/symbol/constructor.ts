...
export const symbolConstructorExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "typeof Symbol('x') is 'symbol'", assertion: "expect(typeof Symbol('x')).toBe('symbol')" },
      { description: 'Symbol returns a symbol primitive', assertion: "expect(typeof Symbol('hello')).toBe('symbol')" },
      { description: 'Symbol with number description', assertion: "expect(typeof Symbol(42 as any)).toBe('symbol')" },
      { description: 'Symbol without description is still a symbol', assertion: "expect(typeof Symbol()).toBe('symbol')" },
      { description: 'Symbol is not a string', assertion: "expect(typeof Symbol('x') === 'string').toBe(false)" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "Symbol('x') !== Symbol('x') is true", assertion: "expect(Symbol('x') !== Symbol('x')).toBe(true)" },
  ...
  },
  {
    ...
    tests: [
      { description: "description is 'desc'", assertion: "expect(Symbol('desc').description).toBe('desc')" },
  ...
  },
  {
    ...
    tests: [
      { description: 'description is undefined when no arg', assertion: 'expect(Symbol().description).toBeUndefined()' },
      { description: 'description is strictly undefined', assertion: 'expect(Symbol().description === undefined).toBe(true)' },
      { description: 'typeof description is undefined', assertion: "expect(typeof Symbol().description).toBe('undefined')" },
      { description: 'Symbol() still creates a symbol', assertion: "expect(typeof Symbol()).toBe('symbol')" },
      { description: 'description undefined, not null', assertion: 'expect(Symbol().description).not.toBeNull()' },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: 'new Symbol() throws', assertion: 'expect(() => new (Symbol as any)()).toThrow()' },
      { description: 'throws a TypeError', assertion: 'expect(() => new (Symbol as any)()).toThrow(TypeError)' },
      ...
      { description: 'Symbol() does not throw', assertion: "expect(() => Symbol('ok')).not.toThrow()" },
    ],
