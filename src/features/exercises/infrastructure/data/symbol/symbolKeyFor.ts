...
export const symbolKeyForExercises: Exercise[] = [
  {
    ...
    tests: [
      { description: "returns 'hello'", assertion: "expect(Symbol.keyFor(Symbol.for('hello'))).toBe('hello')" },
      { description: 'returns the correct key', assertion: "expect(Symbol.keyFor(Symbol.for('world'))).toBe('world')" },
      { description: 'result is a string', assertion: "expect(typeof Symbol.keyFor(Symbol.for('x'))).toBe('string')" },
  ...
  },
  {
    ...
    tests: [
      { description: 'local symbol returns undefined', assertion: "expect(Symbol.keyFor(Symbol('local'))).toBeUndefined()" },
      ...
      { description: 'not null', assertion: "expect(Symbol.keyFor(Symbol('x'))).not.toBeNull();" },
    ],
  ...
  },
  {
    ...
    tests: [
      { description: "return type is 'string'", assertion: "expect(typeof Symbol.keyFor(Symbol.for('x'))).toBe('string')" },
      { description: 'not a symbol', assertion: "expect(typeof Symbol.keyFor(Symbol.for('x')) === 'symbol').toBe(false)" },
  ...
  },
  {
    ...
    tests: [
      { description: 'Symbol.iterator has no global key', assertion: 'expect(Symbol.keyFor(Symbol.iterator)).toBeUndefined()' },
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'equality check', assertion: "expect(Symbol.keyFor(Symbol.for('test')) === 'test').toBe(true)" },
    ],
