...
buf.length  // → 4 (4 bytes for this emoji)`,
  ...
  },
  {
    ...
    tests: [
      ...
      { description: "result has written property", assertion: "expect('written' in new TextEncoder().encodeInto('x', new Uint8Array(10))).toBe(true)" },
      { description: "result has read property", assertion: "expect('read' in new TextEncoder().encodeInto('x', new Uint8Array(10))).toBe(true)" },
    ],
