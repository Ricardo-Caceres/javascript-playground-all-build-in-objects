...
export const typeErrorExercises: Exercise[] = [
  ...
  try {
    ...
    tests: [
      { description: 'returns true when TypeError is caught', assertion: "function getType() { try { (null as any).property; } catch(e) { return e instanceof TypeError; } } expect(getType()).toBe(true)" },
      { description: 'function returns a boolean', assertion: "function getType2() { try { (null as any).x; } catch(e) { return e instanceof TypeError; } } expect(typeof getType2()).toBe('boolean')" },
      { description: 'caught error is also an Error', assertion: "function getType3() { try { (null as any).x; } catch(e) { return e instanceof Error; } } expect(getType3()).toBe(true)" },
      { description: 'caught error has name TypeError', assertion: "function getType4() { try { (null as any).x; } catch(e: any) { return e.name; } } expect(getType4()).toBe('TypeError')" },
      { description: 'throws when accessing property on null', assertion: "expect(() => { (null as any).property; }).toThrow(TypeError)" },
    ],
