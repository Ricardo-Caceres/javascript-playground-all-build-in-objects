...
u.hash  // → '#section'`,
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'origin does not include path', assertion:"expect(new URL('https://example.com/path').origin.includes('/path')).toBe(false)" },
    ],
...
u.searchParams.get('a')  // → '1'`,
  ...
  },
  {
    ...
    tests: [
      ...
      { description: 'old value removed from href', assertion:"const u2=new URL('https://example.com?a=1'); u2.searchParams.set('a','99'); expect(u2.href.includes('a=1')).toBe(false)" },
      ...
      { description: 'searchParams.delete updates href', assertion:"const u4=new URL('https://example.com?a=1&b=2'); u4.searchParams.delete('a'); expect(u4.href.includes('a=1')).toBe(false)" },
