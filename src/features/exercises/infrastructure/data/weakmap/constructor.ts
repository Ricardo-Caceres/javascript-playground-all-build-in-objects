...
export const weakMapConstructorExercises: Exercise[] = [
  {
    ...
    tests: [
      ...
      { description: 'is not null', assertion:'expect(new WeakMap() !== null).toBe(true)' },
...
typeof wm  // → 'object'`,
  ...
  },
  {
    ...
    tests: [
      { description: 'primitive key throws', assertion:"expect(() => new WeakMap([[1, 'v']])).toThrow()" },
      { description: 'string key throws', assertion:"expect(() => new WeakMap([['str', 'v']])).toThrow()" },
      { description: 'null key throws', assertion:"expect(() => { const wm = new WeakMap(); wm.set(null, 1); }).toThrow()" },
      { description: 'object key does not throw', assertion:"expect((() => { try { (() => { const k = {}; new WeakMap([[k, 'v']]); })(); return true; } catch(e) { return false; } })()).toBe(true)" },
      { description: 'array key does not throw', assertion:"expect((() => { try { (() => { const k = []; new WeakMap([[k, 'v']]); })(); return true; } catch(e) { return false; } })()).toBe(true)" },
    ],
